    ...
    <div className="flex items-center justify-center min-h-screen bg-zinc-950 p-4">
      <Card className="w-full max-w-md bg-zinc-900 border-zinc-800">
        <CardHeader className="space-y-1 text-center">
          <div className="flex justify-center mb-4">
            <div className="p-3 rounded-full bg-zinc-800 border border-zinc-700">
              <Package className="h-8 w-8 text-zinc-100" />
            </div>
          </div>
          <CardTitle className="text-2xl">Вход в систему</CardTitle>
          <CardDescription className="text-zinc-400">
            Войдите в админ-панель, используя свою учетную запись Google
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="text-center text-zinc-500 text-sm">
          Для доступа к админ-панели необходимо иметь соответствующие права.
        </CardFooter>
      </Card>
    </div>
  )
